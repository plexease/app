...
STRIPE_PRICE_ESSENTIALS_MONTHLY=$(get_val NEXT_PUBLIC_STRIPE_PRICE_ESSENTIALS_MONTHLY)
STRIPE_PRICE_ESSENTIALS_ANNUAL=$(get_val NEXT_PUBLIC_STRIPE_PRICE_ESSENTIALS_ANNUAL)
...
NEXT_PUBLIC_STRIPE_PRICE_ESSENTIALS_MONTHLY=$STRIPE_PRICE_ESSENTIALS_MONTHLY
NEXT_PUBLIC_STRIPE_PRICE_ESSENTIALS_ANNUAL=$STRIPE_PRICE_ESSENTIALS_ANNUAL
