...
import { PlannerForm } from "@/components/tools/integration-blueprint/planner-form";
import { currentMonthDate } from "@/lib/utils";
import { getUserPlan } from "@/lib/subscription";

export default async function IntegrationBlueprintPage() {
  ...
  return (
    <div>
      <h1 className="font-heading text-2xl font-bold text-white">Integration Blueprint</h1>
      <p className="mt-2 text-muted-400">
        Describe what you need to integrate and get an AI-powered blueprint with recommended
