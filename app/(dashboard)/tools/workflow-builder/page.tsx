...
import { BuilderForm } from "@/components/tools/workflow-builder/builder-form";
...
export default async function WorkflowBuilderPage() {
  ...
  return (
    <div>
      <h1 className="font-heading text-2xl font-bold text-white">Workflow Builder</h1>
      <p className="mt-2 text-muted-400">
        Design automated workflows between your apps — describe what should happen and get
