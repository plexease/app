...
import { ErrorExplainerForm } from "@/components/tools/error-resolver/explainer-form";
import { currentMonthDate } from "@/lib/utils";
import { getUserPlan } from "@/lib/subscription";

export default async function ErrorResolverPage() {
  ...
  return (
    <div>
      <h1 className="font-heading text-2xl font-bold text-white">Error Resolver</h1>
      <p className="mt-2 text-muted-400">
        Paste an error log or stack trace and get a root cause analysis,
