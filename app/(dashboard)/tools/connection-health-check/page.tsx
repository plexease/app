...
import { HealthCheckerForm } from "@/components/tools/connection-health-check/checker-form";
import { currentMonthDate } from "@/lib/utils";
import { getUserPlan } from "@/lib/subscription";

export default async function ConnectionHealthCheckPage() {
  ...
  return (
    <div>
      <h1 className="font-heading text-2xl font-bold text-white">Connection Health Check</h1>
