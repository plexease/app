      ...
      <article className="mx-auto max-w-3xl px-6 py-16">
        ...
        <div className="mt-10 text-sm leading-relaxed text-muted-300">
          ...
          <section className="mt-10 space-y-4">
            <h2 className="font-heading text-xl font-semibold text-white">2. Data We Collect</h2>
          ...
          <section className="mt-10 space-y-4">
            <h2 className="font-heading text-xl font-semibold text-white">3. How We Use Your Data</h2>
          ...
          <section className="mt-10 space-y-4">
            <h2 className="font-heading text-xl font-semibold text-white">4. Third-Party Processors</h2>
          ...
          <section className="mt-10 space-y-4">
            <h2 className="font-heading text-xl font-semibold text-white">5. Cookies</h2>
            <p>
          ...
          <section className="mt-10 space-y-4">
            <h2 className="font-heading text-xl font-semibold text-white">7. Your Rights</h2>
          ...
          <section className="mt-10 space-y-4">
            <h2 className="font-heading text-xl font-semibold text-white">8. International Transfers</h2>
            <p>
          ...
          <section className="mt-10 space-y-4">
            <h2 className="font-heading text-xl font-semibold text-white">9. Children&apos;s Privacy</h2>
            <p>
          ...
          <section className="mt-10 space-y-4">
            <h2 className="font-heading text-xl font-semibold text-white">10. Changes to This Policy</h2>
            <p>
          ...
          <section className="mt-10 space-y-4">
            <h2 className="font-heading text-xl font-semibold text-white">11. Contact</h2>
            <p>
