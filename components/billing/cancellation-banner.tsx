      ...
      <div className="mb-6 flex items-center justify-between rounded-lg border border-red-700 bg-red-950/30 px-4 py-3">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="rounded-lg bg-brand-500 px-4 py-1.5 text-xs font-medium text-white hover:bg-brand-600 disabled:opacity-50 transition-colors focus:outline-none focus:ring-2 focus:ring-brand-500 focus:ring-offset-2 focus:ring-offset-surface-950"
          >
            {resubscribing ? "Resubscribing..." : "Resubscribe"}
          </button>
          <button
            onClick={() => setDismissed(true)}
            className="text-muted-500 hover:text-muted-300 transition-colors focus:outline-none focus:ring-2 focus:ring-brand-500 rounded-lg"
            aria-label="Dismiss"
          >
            &times;
          </button>
