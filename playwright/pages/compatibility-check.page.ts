...
export class CompatibilityCheckPage extends ToolPageBase {
  get heading(): Locator {
    return this.main.getByRole("heading", { name: /compatibility check/i });
  }
  ...
  async goto() {
    await this.page.goto("/tools/compatibility-check");
  }
