...
export class PackageAdvisorPage extends ToolPageBase {
  get heading(): Locator {
    return this.main.getByRole("heading", { name: /package advisor/i });
  }
  ...
  async goto() {
    await this.page.goto("/tools/package-advisor");
  }
