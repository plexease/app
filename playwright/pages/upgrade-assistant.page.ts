...
export class UpgradeAssistantPage extends ToolPageBase {
  get heading(): Locator {
    return this.main.getByRole("heading", { name: /upgrade assistant/i });
  }
  ...
  async goto() {
    await this.page.goto("/tools/upgrade-assistant");
  }
