...
export class IntegrationBlueprintPage extends ToolPageBase {
  get heading(): Locator {
    return this.main.getByRole("heading", { name: /integration blueprint/i });
  }
  ...
  async goto() {
    await this.page.goto("/tools/integration-blueprint");
  }
